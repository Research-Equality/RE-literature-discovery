...
This skill is the advanced OpenAlex companion in the repository.

- Use `skills/literature-search/scripts/search_openalex.py` for standard paper retrieval into the shared corpus
- Use this skill when the task is really about OpenAlex entities, trends, citation networks, or institutional analysis
- Hand results back to `literature-search` / `systematic-review` only after reducing them to a paper-level corpus

## Do Not Use This Skill For

- default first-pass repository-wide discovery
- bibliography repair
- narrative review or manuscript writing
